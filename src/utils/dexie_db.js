...
db.version(2).stores({
    ...
    draft_transaction: '++id, wallet_name, clubcard_url',
    ...
    clubcards: '++id, address, tx_hash, url, wallet_name, host_identity_address, clubcard_name, is_archived, image, display_index, description, display_name, notifications, bought'
});
